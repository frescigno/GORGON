...
current_run = "GP_3pl_YVA_iter2_cut"
...
data = ascii.read("/home/fr307/star_data/HD48948/HD48948_yarara_activity_back_timeseries_iter2_cut.rdb").to_pandas()
...
model_par["ecc_0"] = gp.Parameter(value=0., error=0.1, vary=True)
...
model_par['ecc_1'] = gp.Parameter(value=0.0, error=0.1, vary = True)
...
model_par['ecc_2'] = gp.Parameter(value=0.0, error=0.1, vary = True)
...
model_par_pl2['P'] = model_par2['P_2']
model_par_pl2['K'] = model_par2['K_2']
model_par_pl2['ecc'] = model_par2['ecc_2']
model_par_pl2['omega'] = model_par2['omega_2']
model_par_pl2['t0'] = model_par2['t0_2']
...
allbut_pl0 = GP_rv_data+planet_1_model+planet_2_model
allbut_pl1 = GP_rv_data+planet_0_model+planet_2_model
allbut_pl2 = GP_rv_data+planet_0_model+planet_1_model
