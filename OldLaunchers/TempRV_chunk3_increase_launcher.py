...
savedir = "/home/fr307/TempRVs_analysis/increase/chunk3/"
filename = 'vrad_Sun_T6_increase_lower.csv' #need to change based on file used
datacut=[58170,58310] #change based on chosen cut (numbers can be approximations)
iterations = 20000
numb_chains = 200
numb_cores=5
...
def setup(time, vrad, vrad_err):
    ...
    prior_param5 = gp.Prior_Par_Creator.create("Uniform")  
    prior_param5["minval"] = 0.2
    prior_param5["maxval"] = 1.25
    prior_list.append(("gp_jit", "Uniform", prior_param5))
