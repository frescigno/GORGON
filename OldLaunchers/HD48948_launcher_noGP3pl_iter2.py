...
current_run = "noGP_3pl_YV2_iter2_cut"
...
data = ascii.read("/home/fr307/star_data/HD48948/HD48948_yarara_v2_timeseries_iter2_cut.rdb").to_pandas()
JD = data["jdb"].values + 2.4e6
rv = data["vrad"].values
#err_rv = data["svrad"].values
err_rv = data["svrad"].values + np.sqrt((data["svrad"].values)**2 + 0.85**2)
