...
current_run = "GP_2pl_bd_corr_7x5k"
...
data = ascii.read("/home/fr307/star_data/HD48948/HD48948_yarara_activity_back_timeseries.rdb").to_pandas()
...
######## Planet d
model_par['P_1'] = gp.Parameter(value=151., error=1.0)
...
post_P0_nB, post_K0_nB, post_sk0_nB, post_ck0_nB, post_t00_nB, post_P1_nB, post_K1_nB, post_sk1_nB, post_ck1_nB, post_t01_nB = posterior_recovery_noburnin(fin_model_param, burnin, kernel=False)
...
fileP1_nB = os.path.join(saving_folder, "posterior_P2_nB.txt")
np.savetxt(fileP1_nB, post_P1_nB)
fileK1_nB = os.path.join(saving_folder, "posterior_K2_nB.txt")
np.savetxt(fileK1_nB, post_K1_nB)
filesk1_nB = os.path.join(saving_folder, "posterior_sk2_nB.txt")
np.savetxt(filesk1_nB, post_sk1_nB)
fileck1_nB = os.path.join(saving_folder, "posterior_ck2_nB.txt")
np.savetxt(fileck1_nB, post_ck1_nB)
filet01_nB = os.path.join(saving_folder, "posterior_t02_nB.txt")
np.savetxt(filet01_nB, post_t01_nB)

post_P0, post_K0, post_sk0, post_ck0, post_t00, post_P1, post_K1, post_sk1, post_ck1, post_t01 = posterior_recovery(fin_model_param, kernel=False)
...
fileP1 = os.path.join(saving_folder, "posterior_P2.txt")
np.savetxt(fileP1, post_P1)
fileK1 = os.path.join(saving_folder, "posterior_K2.txt")
np.savetxt(fileK1, post_K1)
filesk1 = os.path.join(saving_folder, "posterior_sk2.txt")
np.savetxt(filesk1, post_sk1)
fileck1 = os.path.join(saving_folder, "posterior_ck2.txt")
np.savetxt(fileck1, post_ck1)
filet01 = os.path.join(saving_folder, "posterior_t02.txt")
...
fileecc1 = os.path.join(saving_folder, "posterior_ecc2.txt")
np.savetxt(fileecc1, post_ecc1)
fileomega1 = os.path.join(saving_folder, "posterior_omega2.txt")
...
fileecc1_nB = os.path.join(saving_folder, "posterior_ecc2_nB.txt")
np.savetxt(fileecc1_nB, post_ecc1_nB)
fileomega1_nB = os.path.join(saving_folder, "posterior_omega2_nB.txt")
...
filemass1 = os.path.join(saving_folder, "mass2.txt")
